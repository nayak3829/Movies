      ...
      <div className="pt-24 pb-8">
        <div className="container mx-auto px-4 mb-8">
          <div className="flex items-center gap-4 border-l-4 border-primary pl-4">
            <TrendingUp className="w-7 h-7 text-primary flex-shrink-0 opacity-50" />
            <div>
              <div className="h-10 w-44 bg-muted/40 rounded animate-pulse" />
              <div className="h-4 w-56 bg-muted/25 rounded animate-pulse mt-2" />
            </div>
          </div>
        </div>
